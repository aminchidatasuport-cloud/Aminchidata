...
<head>
  ...
  <meta name="description" content="AminchiData is Nigeria's most affordable VTU platform. Buy data, airtime, education pins, cable TV subscriptions and pay electricity bills instantly." />
  ...
  <nav class="fixed top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur border-b border-slate-800">
        ...
        <div class="hidden md:flex items-center gap-7">
          ...
          <div class="relative group">
            ...
            <div class="absolute top-8 left-0 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl p-2 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
              ...
              <a href="cable.php" class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm text-slate-300 hover:bg-slate-700 hover:text-white">
                <i class="fa-solid fa-tv text-pink-400 w-4"></i> Cable TV
              </a>
              <a href="fund-account.php" class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm text-slate-300 hover:bg-slate-700 hover:text-white">
                <i class="fa-solid fa-building-columns text-green-400 w-4"></i> Fund Account
              </a>
            </div>
          </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-slate-900 border-t border-slate-800 px-4 py-4">
      <div class="flex flex-col gap-1">
        ...
        <a href="cable.php" class="nav-link px-3 py-2.5 rounded-lg hover:bg-slate-800 text-sm font-medium">
          <i class="fa-solid fa-tv text-pink-400 mr-2"></i>Cable TV
        </a>
        <a href="fund-account.php" class="nav-link px-3 py-2.5 rounded-lg hover:bg-slate-800 text-sm font-medium">
          <i class="fa-solid fa-building-columns text-green-400 mr-2"></i>Fund Account
        </a>
  ...
  <section id="services" class="py-20 bg-slate-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        <a href="cable.php" class="service-card p-6 text-center animate-on-scroll">
          <div class="w-14 h-14 bg-pink-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <i class="fa-solid fa-tv text-pink-400 text-2xl"></i>
          </div>
          <h3 class="text-lg font-bold text-white mb-2">Cable TV</h3>
          <p class="text-slate-400 text-sm">Subscribe to DSTV, GOTV, and Startimes instantly at the best prices.</p>
          <div class="mt-4 text-green-400 text-sm font-semibold">DSTV / GOTV / Startimes <i class="fa-solid fa-arrow-right ml-1"></i></div>
        </a>
      </div>
    </div>
  </section>
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
        ...
        <div>
          ...
          <ul class="space-y-2.5 text-sm">
            ...
            <li><a href="cable.php" class="text-slate-400 hover:text-green-400 transition-colors">Cable TV</a></li>
            <li><a href="fund-account.php" class="text-slate-400 hover:text-green-400 transition-colors">Fund Account</a></li>
          </ul>
        </div>
